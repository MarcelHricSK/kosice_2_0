                ...
                <table>
                  ...
                  <tr>
                    <td>
                      ...
                      <p>
                        Včera sme Vám vypracovali cenovú ponuku pre Váš pobyt v Hilson Jasná Garden resort.
                      </p>
                      <p></p>
                      <p>
                        Aktuálne nemáme od Vás žiadnu spätnú väzbu. Preto by sme Vám radi pripomenuli, že platnosť ponuky vyprší o <strong>{{ relative_serialized_diff(now(), \Carbon\Carbon::parse($offer->expiring_at)) }}</strong>.
                      </p>
                      <p></p>
