                ...
                <table>
                  ...
                  <tr>
                    <td>
                      ...
                      <p>Thank you for your interest about staying in our resort.
                        We have prepared a price offer according to your request as follow:
                      </p>
                      <p></p>
                      <table class="m_-7628555558286833510center">
                        ...
                        <tr>
                          ...
                          <td>
                            <strong>{{ $offer->count_adults }}</strong> x <strong>adult</strong><br>
                            <strong>{{ $offer->count_children }}</strong> x <strong>child</strong><br>
                            <strong>{{ $offer->count_toddlers }}</strong> x <strong>toddler</strong><br>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2">
