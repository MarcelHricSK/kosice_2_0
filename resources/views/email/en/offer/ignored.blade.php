            ...
            <td class="m_-7628555558286833510container">
              <div id="m_-7628555558286833510email_content" class="m_-7628555558286833510content">
                <table>
                  ...
                  <tr>
                    <td>
                      <h1>Dear {{ $offer->profile->full_name }}</h1>
                      <p>
                        We prepared and sent you a price offer for your stay at Hilson Jasná Garden resort yesterday.
                      </p>
                      <p></p>
                      <p>
                        Currently, we do not have any feedback from you.
                        Therefore, we would like to remind you that the validity of the offer will expire in <strong>{{ relative_serialized_diff(now(), \Carbon\Carbon::parse($offer->expiring_at)) }}</strong>.
                      </p>
                      <p></p>
                      <table class="m_-7628555558286833510center">
                        ...
                        <tr>
                          <td colspan="2">
                            <a href="{{ $link }}"
                               style="display: inline-block; border: none; background: black; color: white; padding: 8px 16px; margin-top: 24px;">
                              View the offer
                            </a>
                          </td>
                        </tr>
